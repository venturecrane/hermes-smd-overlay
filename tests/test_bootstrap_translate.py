...
def test_translate_does_not_exclude_agentmail_sends(tmp_path, monkeypatch):
    ...
    assert excluded == {
        ...
        # ever since. Provider/account/list administration is not something an
        # Operator routine does, and connect_provider is an account-level action
        # against our mail vendor that should not be agent-reachable at any
        # ceiling.
        "agent_verify",
        "connect_provider",
        "create_list_entry",
